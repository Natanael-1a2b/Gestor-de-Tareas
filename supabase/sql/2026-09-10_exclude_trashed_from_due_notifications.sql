-- Una tarea movida a la papelera (deleted_at seteado) no debe seguir
-- generando push de "proxima a vencer". Correr DESPUES de
-- 2026-09-10_trash_soft_delete.sql (necesita la columna deleted_at) y
-- DESPUES de 2026-09-08_fix_past_due_notifications.sql (reemplaza esa
